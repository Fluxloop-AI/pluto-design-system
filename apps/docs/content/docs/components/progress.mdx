...
- **이름**: Montage `ProgressIndicator` → **`Progress`**
- **headless**: Montage Emotion keyframes → Tailwind arbitrary + inline `@keyframes pds-progress-indeterminate`
- **토큰**: 트랙 `var(--pds-fill-alternative)`, 바 `var(--pds-primary-normal)`
