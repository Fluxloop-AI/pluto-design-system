...
- **headless**: Montage 의 Emotion + 자체 positioning → `@radix-ui/react-popover`
- **변형 이름**: `PopoverContent variant=normal|custom` 유지 (Montage 와 동일)
- **토큰 치환**: `var(--pds-background-elevated-normal)`, `var(--pds-shadow-lg)`, `var(--pds-z-popover)`
- **z-index**: `--pds-z-popover` (1400)
